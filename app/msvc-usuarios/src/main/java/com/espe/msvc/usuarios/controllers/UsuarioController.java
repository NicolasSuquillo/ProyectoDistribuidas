...
public class UsuarioController {
    ...
    public ResponseEntity<Map<String, String>> login(@RequestBody Map<String, String> credentials) {
        ...
        if (usuarioOptional.isPresent()) {
            ...
            if (service.checkPassword(password, usuario.getPassword())) {
                // Aquí podrías generar un token y devolverlo en la respuesta si estás usando autenticación basada en tokens
